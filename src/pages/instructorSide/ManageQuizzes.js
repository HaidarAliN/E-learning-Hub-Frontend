...
export default function ManageQuizzes() {
  ...
  const getDAta = async () => {
    const response = await axios.get(
      `${BASE_API_URL}/api/instructor/course/get-quiz/${courseId}`,
      {
        headers: {
  ...
  const getQuizquiestion = async (id) => {
    const response = await axios.post(
      `${BASE_API_URL}/api/instructor/course/get-quiz-questions/${courseId}`,
      {
        quiz_id: id,
      },
      {
  ...
  const handleConfirm = async () => {
    if (quizNameT) {
      ...
      const response = await axios.post(
        `${BASE_API_URL}/api/instructor/course/create-quiz/${courseId}`,
        {
          name: quizNameT,
        },
        {
  ...
  const handleRemove = async (id) => {
    const response = await axios.post(
      `${BASE_API_URL}/api/instructor/course/remove-question/${courseId}`,
      {
        quiz_id: quizId,
        question_id: id,
      },
  ...
  const handleEdit = async (id) => {
    const response = await axios.post(
      `${BASE_API_URL}/api/instructor/course/get-quiz-question-by-id/${courseId}`,
      {
        quiz_id: quizId,
        question_id: id,
      },
  ...
  const handleMCQEditUpdate = async (id) => {
    const response = await axios.post(
      `${BASE_API_URL}/api/instructor/course/edit-question/${courseId}`,
      {
        quiz_id: quizId,
  ...
  const addquestion = async (first_ans, second_ans, third_ans) => {
    const response = await axios.post(
      `${BASE_API_URL}/api/instructor/course/add-question/${courseId}`,
      {
        quiz_id: quizId,
        content: newQuestion,
  ...
  return (
    <LayoutCourse title="qwe">
      <div>
                    ...
                    {!quizloaded ? (
                      <div>
                        <Grid container spacing={3}>
                          ...
                          {data && (
                            <div className={classes.formcontrollediv}>
                  ...
                  <Card elevation={1} className={classes.cardbody}>
                    ...
                    <CardContent>
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={1} lg={5} key={76}></Grid>
                      </Grid>
                          ...
                          <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={6} lg={4} key={3}>
                              <TextField
                                key={654}
                                onChange={(e) =>
                                  setNewFirstAnswer(e.target.value)
                                }
                                className={classes.field}
                                variant="outlined"
                                color="primary"
                          ...
                          <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={6} lg={4} key={3}>
                              <TextField
                                key={765}
                                onChange={(e) =>
                                  setNewSecondAnswer(e.target.value)
                                }
                                className={classes.field}
                          ...
                          <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={6} lg={4} key={3}>
                              <TextField
                                key={876}
                                onChange={(e) =>
                                  setNewThirdAnswe(e.target.value)
                                }
                                className={classes.field}
                                variant="outlined"
                                color="primary"
        ...
        {/* edit MCQ section */}
        {questionInfo && (
          <div ref={mcqEditRef} className={classes.card}>
            <Grid container spacing={1}>
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={4} lg={4} key={30}>
                          <TextField
                            key={42}
                            onChange={(e) =>
                              setSecondeditanswer(e.target.value)
                            }
                            className={classes.field}
                            variant="outlined"
                            color="primary"
                        ...
                        <Grid item xs={12} md={12} lg={12} key={60}>
                          <FormControl className={classes.formControl}>
                            ...
                            >
                              <option key={998} value={1}>
                                First
                              </option>
                              <option key={997} value={2}>
                                Second
                              </option>
                              <option key={996} value={3}>
                                third
                              </option>
                            </NativeSelect>
                          </FormControl>
        ...
        {/* edit T or F section */}
        {tofquestionInfo && (
          <div ref={torEditRef} className={classes.card}>
            <Grid container spacing={1}>
