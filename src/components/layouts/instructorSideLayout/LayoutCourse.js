    ...
    <div>
      ...
      <List>
        <ListItem
          ...
          className={
            location.pathname == "/course/UploadMaterial"
              ? classes.active
              : null
          }
        >
      ...
      <List>
        <ListItem
          ...
          className={
            location.pathname == "/course/ManageQuizzes" ? classes.active : null
          }
        >
          <ListItemIcon>
      ...
      <List>
        <ListItem
          ...
          className={
            location.pathname == "/course/ManageStudents"
              ? classes.active
              : null
          }
        >
      ...
      <List>
        <ListItem
          ...
          className={
            location.pathname == "/course/StudentSubmissions"
              ? classes.active
              : null
          }
        >
      ...
      <List>
        <ListItem
          ...
          className={
            location.pathname == "/course/EditInfo" ? classes.active : null
          }
        >
          <ListItemIcon>
